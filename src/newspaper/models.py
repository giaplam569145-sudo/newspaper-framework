...
class Article:
    ...
    def __post_init__(self):
        ...
        if self.image_path and not os.path.exists(self.image_path):
            # We log a warning but don't stop execution, handled in Newspaper class or here.
            # Printing is discouraged in libraries, better to use logging,
            # but sticking to simple behavior for now as per "Readability" and simple framework.
